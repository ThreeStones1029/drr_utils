...
def main():
    ...
    parser.add_argument('--image_input_dir', help='image directory', default="data/S0000328_example/JPEGImages")
    parser.add_argument(
        '--output_dir', help='output dataset directory', default='data/S0000328_example')
    parser.add_argument(
        '--train_proportion',
