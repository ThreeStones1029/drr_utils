...
LastEditTime: 2024-06-26 13:13:52
'''
import sys
import os
...
if __name__ == "__main__":
    ...
    conver_gt_bbox_to_fracture_annotation_file("data/Fracture_dataset/LA/gt_bbox.json", 
                                               "data/Local_fracture/fracture_grading_info.json",
                                               "data/Fracture_dataset/LA/fracture_gt_bbox.json")
    split_cut_images2_fracture_and_normal_dataset("data/Local_fracture/fracture_grading_info.json",
